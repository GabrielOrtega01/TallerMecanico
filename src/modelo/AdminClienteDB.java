...
public class AdminClienteDB extends Conexion implements CRUD {
    ...
    public Object insertar(Object obj) {
        ...
        try {
            String sql = "INSERT INTO cliente(doc, nom, apelli, direcc, correo) VALUES(?,?,?,?,?)";
            ...
            preparedStatement.setString(2, objCliente.getNom());
            preparedStatement.setString(3, objCliente.getApelli());
            preparedStatement.setString(4, objCliente.getDirecc());
    ...
    public boolean actualizar(Object obj) {
        ...
        Connection conex = abrirConexion();
        try {
            String sql = "UPDATE cliente SET doc=?,nom=?,apelli=?,direcc=?,correo=?  WHERE idc=?";
    ...
    public List<Object> listarTodo() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                objCliente.setNom(resultSet.getString("nom"));
                objCliente.setApelli(resultSet.getString("apelli"));
