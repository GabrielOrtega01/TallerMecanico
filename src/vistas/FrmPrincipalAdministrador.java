...
public class FrmPrincipalAdministrador extends javax.swing.JFrame {
    ...
    private void submenuAdmMecanicosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submenuAdmMecanicosActionPerformed
        FrmDiagAdminMecanicos objFrmDiagAdmMecanico = new FrmDiagAdminMecanicos(this, true);
        objFrmDiagAdmMecanico.setLocationRelativeTo(null);
        objFrmDiagAdmMecanico.setVisible(true);
